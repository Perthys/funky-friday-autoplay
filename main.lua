...
9/18/21
   ! This Updated was provided by Perth
   
   + Localized Multi Called Functions Like pcall and type to semi optimize code
   + Added seimcolons for more consistency
   + better identing (for consistency)
...
local window = library:CreateWindow('Funky Friday') do
    ...
    local folder = window:AddFolder('Credits') do
        ...
        folder:AddLabel({ text = 'Perth - Contributor'});
    end;

    window:AddLabel({ text = 'Version 1.4b' });
    window:AddLabel({ text = 'Updated 9/18/21' });
